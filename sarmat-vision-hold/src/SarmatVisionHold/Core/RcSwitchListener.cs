...
namespace SarmatVisionHold.Core
{
 ...
 {
  private readonly VisionHoldSettings settings; private readonly IClock clock; private bool state; private bool? candidate; private DateTime candidateSince;
  public bool State => state; public int LastPwm { get; private set; } public DateTime LastSampleUtc { get; private set; }
  public event Action<bool> StateChanged;
  public RcSwitchListener(VisionHoldSettings settings,IClock clock=null) { this.settings=settings;this.clock=clock??new SystemClock(); }
  public void Update(int pwm) => Update(pwm,clock.UtcNow);
  ...
  public void CheckStale() => CheckStale(clock.UtcNow);
