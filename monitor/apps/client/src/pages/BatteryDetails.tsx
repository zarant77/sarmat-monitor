...
import { Archive, ArrowLeft, ArrowRightLeft, BatteryCharging, BatteryLow, BatteryMedium, CalendarClock, Camera, Check, Gauge, MessageSquare, Pencil, Plus, RotateCcw, SearchCheck, SlidersHorizontal, Trash2, Wrench } from "lucide-react";
