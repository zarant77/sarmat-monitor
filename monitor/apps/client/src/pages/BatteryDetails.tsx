...
import { Archive, ArrowLeft, ArrowRightLeft, BatteryCharging, BatteryLow, BatteryMedium, CalendarClock, Gauge, Pencil, Plus, RotateCcw, SlidersHorizontal, Trash2 } from "lucide-react";
