...
import { BatteryCharging, Gauge, Globe2, Layers3, LayoutDashboard, LogOut, Maximize, Minimize, Monitor, RadioTower, Settings, Shield, Users } from "lucide-react";
...
export function App() {
  ...
  if(location.pathname==="/login") return <Navigate to="/admin" replace/>;
